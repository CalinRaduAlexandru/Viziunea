...
select id, author_id, title, body, post_type, city, interest, interests, event_date, entity_type, representation_type, represented_name, contact_method, contact_value, image_url, status, created_at, updated_at
